...
private:
  ...
  float applyFilter(CircularBuffer<T, bufferLength> &buffer, const float *filter, size_t filterLength);
...
public:
  ...
  void setAdcValKeyUp(int value)
  {
    adcValKeyUp = value;
    updateADCParams();
  }
  void setAdcValKeyDown(int value)
  {
    adcValKeyDown = value;
    updateADCParams();
  }
